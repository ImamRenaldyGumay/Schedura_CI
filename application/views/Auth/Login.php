...
<body>
        ...
        <div class="login-left">
            <div class="login-form-box">
                <div class="text-center mb-4">
                    <img src="<?= base_url('asset') ?>/dist/img/AdminLTELogo.png" alt="Logo" style="height:40px;">
                </div>
                <div class="login-title">Sign In to TodoList</div>
                <div class="login-subtitle">Start your journey</div>
    ...
    <!-- AdminLTE local JS -->
    <script src="<?= base_url('asset') ?><?= base_url('asset') ?>/plugins/jquery/jquery.min.js"></script>
